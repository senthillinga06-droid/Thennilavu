...
<body>
    ...
    <div class="app-container">
        ...
        <main class="content-container">
            ...
            <div class="quick-actions">
                <button class="action-btn" onclick="window.location.href='tel:+94771234567'">
                    <i class="fas fa-phone"></i>
                    Call Now
                </button>
                <button class="action-btn" onclick="window.location.href='mailto:info@Thennilavu.com'">
                    <i class="fas fa-envelope"></i>
                    Email Us
                </button>
                <button class="action-btn" onclick="window.open('https://wa.me/94771234567', '_blank')">
            ...
            <div class="contact-grid">
                <div class="contact-card fade-in" style="animation-delay: 0.1s">
                    ...
                    <p class="contact-card-text">123 Main Street<br>Colombo, Sri Lanka</p>
                </div>
                ...
                <div class="contact-card fade-in" style="animation-delay: 0.2s">
                    ...
                    <p class="contact-card-text">+94 77 123 4567<br>+94 11 234 5678</p>
                </div>
                ...
                <div class="contact-card fade-in" style="animation-delay: 0.3s">
                    ...
                    <p class="contact-card-text">info@Thennilavu.com<br>support@Thennilavu.com</p>
                </div>
            </div>
    ...
    <script>
        ...
        function validateForm() {
            ...
            // The form will submit normally to PHP
            return true;
        }
