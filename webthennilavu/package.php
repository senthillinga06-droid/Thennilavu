...
<body>
    ...
    <section class="py-5">
        <div class="container">
            <h2 class="text-center section-title">Why Choose TheanNilavu?</h2>
                        ...
                        <div class="payment-section-card">
                            ...
                            <div class="bank-info-card">
                                ...
                                <p class="bank-details">
                                    <span>Bank:</span> Commercial Bank<br>
                                    <span>Account Number:</span> 1234567890<br>
                                    <span>Account Name:</span> TheanNilavu Matrimony<br>
                                    <span>Branch:</span> Colombo Main Branch
                                </p>
                            </div>
