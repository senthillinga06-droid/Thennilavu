...
$where_conditions[] = "COALESCE(members.profile_hidden, 0) = 0";
...
<head>
    ...
    <title>Members - TheanNilavu Matrimony</title>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="member-card">
                        ...
                        <div class="member-img">
                            ...
                            // 1. User has a package with profile_hide_enabled = 'Yes'
                            // 2. User has set their profile_hidden = 1
                            $profileHideEnabled = $match['profile_hide_enabled'] ?? 'No';
                            $profileHidden = intval($match['profile_hidden'] ?? 0);
                            
                            if ($profileHideEnabled === 'Yes' && $profileHidden === 1) {
                      ...
                      <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="member-card">
                            ...
                            <div class="member-img">
                                ...
                                // 1. User has a package with profile_hide_enabled = 'Yes'
                                // 2. User has set their profile_hidden = 1
                                $profileHideEnabled = $member['profile_hide_enabled'] ?? 'No';
                                $profileHidden = intval($member['profile_hidden'] ?? 0);
                                
                                // Debug comment (visible in page source)
                                echo "<!-- Member ID: " . $member['id'] . " | Package: " . ($member['package_name'] ?? 'Unknown') . " | Hide Enabled: " . $profileHideEnabled . " | Profile Hidden: " . $profileHidden . " | Should Hide: " . ($profileHideEnabled === 'Yes' && $profileHidden === 1 ? 'YES' : 'NO') . " -->";
                    ...
                    <div class="row">
                        ...
                        <div class="tab-pane fade show active" id="basic" role="tabpanel">
                            <div class="row g-2">
                                ...
                                <div class="col-6"><small><strong>Country:</strong> <span id="countryVal">-</span></small></div>                                <div class="col-6"><small><strong>Phone:</strong> <span id="phoneVal">-</span></small></div>
                        ...
                        <div class="tab-pane fade" id="family" role="tabpanel">
                            <div class="row g-2">
                                ...
                                <div class="col-6"><small><strong>Father Contact:</strong> <span id="fatherContactVal">-</span></small></div>
                                ...
                                <div class="col-6"><small><strong>Mother Contact:</strong> <span id="motherContactVal">-</span></small></div>
