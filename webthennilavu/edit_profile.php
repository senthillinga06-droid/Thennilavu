...
<head>
    ...
    <title>Edit Profile - TheanNilavu Matrimony</title>
            ...
            <div class="form-section">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" name="father_profession" value="<?php echo htmlspecialchars($family['father_profession'] ?? ''); ?>" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Father's Contact</label>
                        <input type="text" class="form-control" name="father_contact" value="<?php echo htmlspecialchars($family['father_contact'] ?? ''); ?>" required>
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" name="mother_profession" value="<?php echo htmlspecialchars($family['mother_profession'] ?? ''); ?>" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Mother's Contact</label>
                        <input type="text" class="form-control" name="mother_contact" value="<?php echo htmlspecialchars($family['mother_contact'] ?? ''); ?>" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Brothers Count</label>
                        <input type="number" class="form-control" name="brothers" value="<?php echo htmlspecialchars($family['brothers_count'] ?? ''); ?>" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Sisters Count</label>
                        <input type="number" class="form-control" name="sisters" value="<?php echo htmlspecialchars($family['sisters_count'] ?? ''); ?>" required>
                    </div>
                </div>
            </div>
