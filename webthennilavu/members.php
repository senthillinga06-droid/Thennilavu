...
<head>
    ...
    <title>Membership - TheanNilavu Matrimony</title>
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="img/LogoBG1.png" alt="TheanNilavu Logo" width="240" height="144">
            </a>
                ...
                <form id="familyInfoForm">
                    <div class="form-card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label required"><i class="bi bi-briefcase"></i> Father's Profession / <span style="font-weight: normal; padding-left: 4px;">தந்தையின் தொழில்</span></label>
                                    <input type="text" class="form-control" name="father_profession" placeholder="Enter father's profession" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label required"><i class="bi bi-telephone"></i> Father's Contact / <span style="font-weight: normal; padding-left: 4px;">தந்தையின் தொடர்பு எண்</span></label>
                                    <input type="text" class="form-control" name="father_contact" placeholder="Phone number" required>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label required"><i class="bi bi-briefcase"></i> Mother's Profession / <span style="font-weight: normal; padding-left: 4px;">தாயின் தொழில்</span></label>
                                    <input type="text" class="form-control" name="mother_profession" placeholder="Enter mother's profession" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label required"><i class="bi bi-telephone"></i> Mother's Contact / <span style="font-weight: normal; padding-left: 4px;">அம்மாவின் தொடர்பு எண்</span></label>
                                    <input type="text" class="form-control" name="mother_contact" placeholder="Phone number" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label required"><i class="bi bi-gender-male"></i> Total Brothers / <span style="font-weight: normal; padding-left: 4px;">மொத்த சகோதரர்கள்</span></label>
                                    <input type="number" class="form-control" name="brothers" placeholder="Eg: 2" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label required"><i class="bi bi-gender-female"></i> Total Sisters / <span style="font-weight: normal; padding-left: 4px;">மொத்த சகோதரிகள்</span></label>
                                    <input type="number" class="form-control" name="sisters" placeholder="Eg: 1" required>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><i class="bi bi-envelope me-2"></i> info@theannilavu.com</li>
