...
<body>
    ...
    <header class="app-header">
        <div class="header-left">
            ...
            <h1 class="header-title">TheanNilavu</h1>
        </div>
    ...
    <main>
        ...
        <section class="about-card fade-in">
            ...
            <p class="about-description">
                TheanNilavu is a trusted marriage platform dedicated to helping individuals find 
        ...
        <section class="section-card fade-in">
            ...
            <div class="testimonials-slider">
                ...
                <?php else: ?>
                    <div class="testimonial-card">
                        <p class="testimonial-text">"TheanNilavu helped me find my perfect match. Highly recommended!"</p>
                        <div class="testimonial-header">
                            <div class="testimonial-info">
                                <h4>Happy Client</h4>
                                <p>Member</p>
